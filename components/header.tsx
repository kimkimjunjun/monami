        ...
        <div className="w-full h-20 border-b border-[#eaeaea]">
            <div className="flex w-[80%] h-20 mx-auto items-center space-x-20">
                ...
                <div>
                    ...
                    <div className={`${isOpen.introduction ? "block transition-div" : "hidden"} absolute -ml-16 top-20 w-52 flex flex-col px-5 shadow-md text-center space-y-3 opacity-90`}>
                ...
                <div>
                    ...
                    <div className={`${isOpen.products ? "block" : "hidden"} absolute -ml-16 top-20 w-52 flex flex-col px-5 shadow-md text-center space-y-3 opacity-90`}>
                ...
                <div>
                    ...
                    <div className={`${isOpen.news ? "block" : "hidden"} absolute -ml-16 top-20 w-52 flex flex-col px-5 shadow-md text-center space-y-3 opacity-90`}>
                ...
                <div>
                    ...
                    <div className={`${isOpen.competition ? "block" : "hidden"} absolute -ml-16 top-20 w-52 flex flex-col px-5 shadow-md text-center space-y-3 opacity-90`}>
                ...
                <div>
                    ...
                    <div className={`${isOpen.support ? "block" : "hidden"} absolute -ml-16 top-20 w-52 flex flex-col px-5 shadow-md text-center space-y-3 opacity-90`}>
                ...
                <div>
                    ...
                    <div className={`${isOpen.purchase ? "block" : "hidden"} absolute -ml-16 top-20 w-52 flex flex-col px-5 shadow-md text-center space-y-3 opacity-90`}>
